...
{
    [DataContract(Name = "AffiliationToDebitPostPaid")]
    public class AffiliationToDebit
    {
        ...
        [DataMember]
        public string MOTIVO { get; set; } //motivo de rechazo
        ...
        [DataMember]
        public string COD_ENTIDAD { get; set; } //código entidad bancaria

        [Data.DbColumn("DESC_MONEDA")]
        [DataMember]
        public string DESC_MONEDA { get; set; } //descripción moneda

        [Data.DbColumn("DESC_TIPO_CUENTA")]
        [DataMember]
        public string DESC_TIPO_CUENTA { get; set; } //descripción tipo cuenta
